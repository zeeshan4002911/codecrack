...
[_nghost-%COMP%]   .layer-drag-handle[_ngcontent-%COMP%]:active {
  cursor: grabbing;
}`]})}class St{worker;workerStatus$=new wt(!1);output$=new wt("Click Run button to execute code");waitingForInput$=new wt(!1);selectedLanguage={id:"",name:""};config(o){if(this.terminate(),this.selectedLanguage=o,this.output$.next(`Loading the ${this.selectedLanguage.name} worker for environment....⏳
`),console.info(`Loading started for ${this.selectedLanguage.name} worker`),o.id=="javascript"?this.worker=new Worker(new URL("/assets/js.worker-DaGOnG9i.js",import.meta.url),{type:"module"}):o.id=="typescript"?this.worker=new Worker(new URL("/assets/ts.worker-CbuK8GRL.js",import.meta.url),{type:"module"}):o.id==="python"&&(this.worker=new Worker(new URL("/assets/python.worker-BTpmAEDA.js",import.meta.url),{type:"module"})),!this.worker){this.output$.next(`No worker present for ${this.selectedLanguage.name}`);return}this.worker.onmessage=({data:e})=>{switch(e.type){case"output":this.output$.next(this.output$.value+e.value+`
`);break;case"input-request":this.waitingForInput$.next(!0);break;case"done":this.output$.next(this.output$.value+`[Finished in ${e.value} ms]
`);break;case"error":this.output$.next(this.output$.value+e.value);break;case"ready":this.output$.next(`${this.selectedLanguage.name} Worker is loaded and ready to use 🎉`),console.info(`${this.selectedLanguage.name} Worker is loaded and ready to use`),this.workerStatus$.next(!0);break}}}run(o){this.worker||this.config(this.selectedLanguage),this.output$.next(`Executing the code....
`),this.worker&&this.worker.postMessage({type:"run",code:o})}sendInput(o){this.waitingForInput$.next(!1),this.worker?.postMessage({type:"input",value:o})}terminate(){this.worker?.terminate(),this.worker=void 0,this.workerStatus$.next(!1),this.waitingForInput$.next(!1)}static ɵfac=function(e){return new(e||St)};static ɵprov=Z({token:St,factory:St.ɵfac,providedIn:"root"})}const uu=(i,o,e,t,n)=>({top:i,left:o,width:e,height:t,cursor:n}),hu=(i,o)=>({"header-dark":i,"header-light":o}),gu=i=>({"run-disable":i}),gn=i=>({"active-border":i}),pu=(i,o)=>({"theme-dark":i,"theme-light":o});function fu(i,o){if(i&1){const e=H();u(0,"input",15),v("keydown.enter",function(n){C(e);const s=_();return y(s.submit(n))}),h()}i&2&&ge("min-width","fit-content")}function mu(i,o){if(i&1){const e=H();u(0,"div",16),v("mousedown",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))})("touchstart",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))}),h()}}function _u(i,o){if(i&1){const e=H();u(0,"div",17),v("mousedown",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))})("touchstart",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))}),h()}}function Cu(i,o){if(i&1){const e=H();u(0,"div",18),v("mousedown",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))})("touchstart",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))}),h()}}function yu(i,o){if(i&1){const e=H();u(0,"div",19),v("mousedown",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))})("touchstart",function(n){C(e);const s=_();return y(s.resizeStartHandler(n))}),k(1,"i",20),h()}}class Tn{_appInit;_codeRunner;_destroy=new Be;viewContainer;selectedLayout="";sizeEmitter=new X;position={top:50,left:50};defaultSize={width:300,height:200};size={width:300,height:200};dragStart={x:0,y:0};isResizableEnable=!0;isDraggableEnable=!0;isResizing=!1;isDragging=!1;isDarkMode=!1;output="";waitingForInput=!1;workerStatus=!1;selectedLanguage={};constructor(o,e){this._appInit=o,this._codeRunner=e,this._appInit.themeMode$.pipe(oe(this._destroy)).subscribe(t=>{const n=t=="dark";this._appInit.editorOptions.theme=n?"vs-dark":"vs",this.isDarkMode=n}),this._appInit.selectedLanguage$.pipe(oe(this._destroy)).subscribe(t=>{this.selectedLanguage=t}),this._codeRunner.output$.pipe(oe(this._destroy)).subscribe(t=>this.output=t),this._codeRunner.waitingForInput$.pipe(oe(this._destroy)).subscribe(t=>this.waitingForInput=t),this._codeRunner.workerStatus$.pipe(oe(this._destroy)).subscribe(t=>this.workerStatus=t)}submit(o){this.waitingForInput=!1,this._codeRunner.sendInput(o.target.value),o.target.value=""}runCode(){if(!this.workerStatus){console.warn("Worker is not ready to use.");return}const o=this._appInit.editorCode;this._codeRunner.run(o)}ngOnChanges(o){if(o.viewContainer&&!o.viewContainer.isFirstChange()){const e=this.viewContainer?.nativeElement?.offsetHeight??0;this.position.top=e-this.size.height,this.position.left=0}o.selectedLayout&&this.layoutChangeHandler(this.selectedLayout)}ngOnInit(){}ngAfterViewInit(){}onResize(o){this.layoutChangeHandler(this.selectedLayout)}layoutChangeHandler(o){this.selectedLayout=o;const e=this.viewContainer?.nativeElement?.offsetHeight??0,t=this.viewContainer?.nativeElement?.offsetWidth??0;this.isResizableEnable=!1,this.isDraggableEnable=!1,o=="bottom"?(this.position.top=e-this.size.height,this.position.left=0,this.size.width=t,this.size.height=this.defaultSize.height,this.sizeEmitter.emit({...this.size,layout:o})):o=="left"?(this.position.top=0,this.position.left=0,this.size.height=e,this.size.width=this.defaultSize.width,this.sizeEmitter.emit({...this.size,layout:o})):o=="right"?(this.position.top=0,this.position.left=t-this.size.width,this.size.height=e,this.size.width=this.defaultSize.width,this.sizeEmitter.emit({...this.size,layout:o})):o=="separate-window"&&(this.isResizableEnable=!0,this.isDraggableEnable=!0,this.size={...this.defaultSize},this.position={top:50,left:50},this.sizeEmitter.emit({width:0,height:0,layout:o}))}dragStartHandler(o){if(!this.isDraggableEnable)return;this.isDragging=!0;const e=o instanceof MouseEvent?o.clientX:o.touches[0].clientX,t=o instanceof MouseEvent?o.clientY:o.touches[0].clientY;this.dragStart.x=e-this.position.left,this.dragStart.y=t-this.position.top,o.preventDefault()}resizeStartHandler(o){o.preventDefault(),this.isResizableEnable&&(this.isResizing=!0)}_f1(o){const e=o instanceof MouseEvent?o.clientX:o.touches[0].clientX,t=o instanceof MouseEvent?o.clientY:o.touches[0].clientY;if(this.isResizing){const n=this.viewContainer?.nativeElement?.offsetHeight??0,s=this.viewContainer?.nativeElement?.offsetWidth??0;let r=e-this.position.left,a=t-this.position.top;r=Math.min(r,s-this.position.left),a=Math.min(a,n-this.position.top);const l=300,c=200;r=Math.max(r,l),a=Math.max(a,c),this.size.width=r,this.size.height=a}else this.isDragging&&(this.position.left=e-this.dragStart.x,this.position.top=t-this.dragStart.y,this.checkStickPosition())}_f2(){this.isDragging=!1,this.isResizing=!1}checkStickPosition(){const e=this.viewContainer?.nativeElement?.offsetHeight??0,t=this.viewContainer?.nativeElement?.offsetWidth??0;this.position.left<5?this.position.left=0:this.position.left+this.size.width>t-5&&(this.position.left=t-this.size.width),this.position.top<5?this.position.top=0:this.position.top+this.size.height>e-5&&(this.position.top=e-this.size.height)}ngOnDestroy(){this._destroy.next(!1),this._destroy.complete(),this.position={top:0,left:0},this.size={width:0,height:0},this.dragStart={x:0,y:0},this.isResizing=!1,this.isDragging=!1,this.output="",this.waitingForInput=!1,this.workerStatus=!1,this.selectedLanguage={}}static ɵfac=function(e){return new(e||Tn)(E(Xe),E(St))};static ɵcmp=nt({type:Tn,selectors:[["app-terminal-view"]],hostBindings:function(e,t){e&1&&v("resize",function(s){return t.onResize(s)},Et)("mousemove",function(s){return t._f1(s)},dt)("touchmove",function(s){return t._f1(s)},dt)("mouseup",function(){return t._f2()},dt)("touchend",function(){return t._f2()},dt)},inputs:{viewContainer:"viewContainer",selectedLayout:"selectedLayout"},outputs:{sizeEmitter:"sizeEmitter"},features:[It],decls:18,vars:33,consts:[["id","terminal-view",1,"d-flex","flex-column",3,"mousedown","touchstart","ngStyle"],[1,"header","d-flex","justify-content-between","py-1","px-2",3,"ngClass"],[1,"terminal-control","d-flex"],[1,"bi","bi-play-fill","cursor-pointer",3,"click","ngClass"],[1,"bi","bi-layout-sidebar","layout-bottom","cursor-pointer",3,"click","ngClass"],[1,"bi","bi-layout-sidebar","cursor-pointer",3,"click","ngClass"],[1,"bi","bi-layout-sidebar-reverse","cursor-pointer",3,"click","ngClass"],[1,"bi","bi-box-arrow-down-left","separate-window","cursor-pointer",3,"click","ngClass"],[1,"terminal-content","py-1","px-2","flex-grow-1","overflow-scroll",3,"ngClass"],[1,"terminal-output","d-block","m-0"],["autofocus","",1,"px-1","auto-input","w-100",3,"minWidth"],[1,"resize-handler","resize-handler-bottom","w-100","position-absolute"],[1,"resize-handler","resize-handler-right","h-100","position-absolute"],[1,"resize-handler","resize-handler-left","h-100","position-absolute"],[1,"resize-handler-window","d-flex"],["autofocus","",1,"px-1","auto-input","w-100",3,"keydown.enter"],[1,"resize-handler","resize-handler-bottom","w-100","position-absolute",3,"mousedown","touchstart"],[1,"resize-handler","resize-handler-right","h-100","position-absolute",3,"mousedown","touchstart"],[1,"resize-handler","resize-handler-left","h-100","position-absolute",3,"mousedown","touchstart"],[1,"resize-handler-window","d-flex",3,"mousedown","touchstart"],[1,"bi","bi-bounding-box","resize-handler-icon"]],template:function(e,t){e&1&&(u(0,"div",0),v("mousedown",function(s){return t.dragStartHandler(s)})("touchstart",function(s){return t.dragStartHandler(s)}),u(1,"div",1)(2,"div"),w(3,"Terminal"),h(),u(4,"div",2)(5,"i",3),v("click",function(){return t.runCode()}),h(),u(6,"i",4),v("click",function(){return t.layoutChangeHandler("bottom"),t.layoutChangeHandler("bottom")}),h(),u(7,"i",5),v("click",function(){return t.layoutChangeHandler("left"),t.layoutChangeHandler("left")}),h(),u(8,"i",6),v("click",function(){return t.layoutChangeHandler("right"),t.layoutChangeHandler("right")}),h(),u(9,"i",7),v("click",function(){return t.layoutChangeHandler("separate-window")}),h()()(),u(10,"div",8)(11,"pre",9),w(12),h(),Y(13,fu,1,2,"input",10),h(),Y(14,mu,1,0,"div",11)(15,_u,1,0,"div",12)(16,Cu,1,0,"div",13)(17,yu,2,0,"div",14),h()),e&2&&(L("ngStyle",Nr(11,uu,t.position.top+"px",t.position.left+"px",t.size.width+"px",t.size.height+"px",t.selectedLayout==="separate-window"?"move":"")),f(),L("ngClass",We(17,hu,t.isDarkMode,!t.isDarkMode)),f(4),L("ngClass",Ce(20,gu,!t.workerStatus)),f(),L("ngClass",Ce(22,gn,t.selectedLayout==="bottom")),f(),L("ngClass",Ce(24,gn,t.selectedLayout==="left")),f(),L("ngClass",Ce(26,gn,t.selectedLayout==="right")),f(),L("ngClass",Ce(28,gn,t.selectedLayout==="separate-window")),f(),L("ngClass",We(30,pu,t.isDarkMode,!t.isDarkMode)),f(2),we(t.output),f(),j(t.waitingForInput?13:-1),f(),j(t.selectedLayout==="bottom"?14:t.selectedLayout==="right"?15:t.selectedLayout==="left"?16:t.selectedLayout==="separate-window"?17:-1))},dependencies:[Tt,bn,si],styles:[`[_nghost-%COMP%]   #terminal-view[_ngcontent-%COMP%] {
  position: absolute;
  z-index: 10;
}
...
[_nghost-%COMP%]   #terminal-view[_ngcontent-%COMP%]   .header[_ngcontent-%COMP%]   .run-disable[_ngcontent-%COMP%] {
  cursor: not-allowed;
  pointer-events: none;
  opacity: 0.5;
}
